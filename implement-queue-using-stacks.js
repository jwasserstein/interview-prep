...
MyQueue.prototype.pop = function() {
    ...
    const val = this.secondaryStack.pop();
...
MyQueue.prototype.peek = function() {
    ...
    const val = this.secondaryStack[this.secondaryStack.length-1];
    while(this.secondaryStack.length > 0){
        this.primaryStack.push(this.secondaryStack.pop());
    }
    return val;
...
MyQueue.prototype.peek = function() {
    ...
    const val = this.primary[this.primary.length-1];
    while (this.secondary.length > 0) {
        this.primary.push(this.secondary.pop());
    }
    return val;
 ...
 */
 ...
 var MyQueue = function() {
  ...
  MyQueue.prototype.peek = function() {
    ...
    const val = this.secondary[this.secondary.length-1];
    while (this.secondary.length > 0) {
      this.primary.push(this.secondary.pop());
    }
    return val;
